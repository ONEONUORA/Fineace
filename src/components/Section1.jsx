...
const Section2 = () => {
  ...
  return (
    <>
    <main className="bg-[rgba(220,223,234,1)] m-10 rounded-3xl">
    <nav className="flex justify-between border-b border-2 border-white py-[2rem] px-[5rem] ">
        <Link to='/'>
          <img
            src={Logo}
            alt="Brand Logo"
        ...
        <div className="flex gap-7">
          <div className="flex h-[53px] w-[136px] gap-2 rounded-[12px] bg-[rgba(245,239,235,1)] p-[16px]">
            ...
            <a href="" className="text-[rgba(255,69,13,1) text-[16px] font-[500]">
              Dashboard
            </a>
          </div>

          <a href="" className="h-[53px] w-[140px] rounded-[10px] p-[16px]">
            Departments
          </a>
        ...
        <section>
          <div className="flex justify-between px-[5rem] py-5">
            ...
            <div className="flex gap-5 mt-5">
              ...
              <button
                className="h-[45px] w-[151px] gap-[8px] rounded-[12px] border-[1px] border-[rgba(255,69,13,1)] bg-transparent text-[rgba(255,69,13,1)] hover:bg-gray-500 hover:text-white"
          ...
          {isOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
              <div className="relative w-[436px] rounded-[24px] bg-white p-6 shadow-lg flex flex-col justify-center">
